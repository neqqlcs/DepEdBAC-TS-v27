...
<body> <!-- The body tag must wrap your content -->
<div class="header">
...
<style>
   .header {
        ...
        box-shadow: 0 2px 5px rgba(0,0,0,0.2); /* Added subtle shadow for distinction when sticky */
    }
...
<?php endif; ?>
<?php endif; ?>
</body> <!-- Closing body tag added here -->
</html>